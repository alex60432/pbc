...
class sendMessage(APIView):
    ...
    def post (self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            send_mail(
            "your code",
            "your code is "+code+". Contact this email if you find any bug or have any suggestion.",
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            if len(checkexist)>0: 
                print(checkexist)
                print(password)
                print(checkexist[0].password)
                print(checkexist[0].password!=password)
                if checkexist[0].password!=password:
                    return Response(False,status=status.HTTP_200_OK)
                else:
                    print(checkexist[0].userid)
